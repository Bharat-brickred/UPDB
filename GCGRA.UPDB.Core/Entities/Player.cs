...
namespace GCGRA.UPDB.Core.Entities
{
    public class Player
    {
        public long PAI_0000200_Operator_Player_ID { get; set; }
        ...
        public string PAI_0001100_Date_of_Birth { get; set; }  // You might want to consider using DateTime
        ...
        public string PAI_0001600_StateProvince { get; set; }  // Adjusted to avoid issues with 'State/Province' name
        ...
        public string PAI_0002200_Document_Expiry_Date { get; set; }  // You might want to use DateTime
        public int PAI_0002300_Operator_Account_Status_ID { get; set; }
        public string PAI_0002400_Account_Creation_Date { get; set; }  // You might want to use DateTime
        public string PAI_0002500_Last_Login_Date_and_Time { get; set; }  // You might want to use DateTime
        public decimal PAI_0002600_Account_Balance { get; set; }
        public int PAI_0002800_Marketing_Opt_in_Status_ID { get; set; }
        public string PAI_0002900_Marketing_Opt_in_Status_Updated { get; set; }  // You might want to use DateTime
        public string PAI_0003000_Date_and_Time_of_Last_Marketing_Message { get; set; }  // You might want to use DateTime
        public int PAI_0003100_AML_Risk_Assessment_Score_ID { get; set; }
        public string PAI_0003200_Payment_Method_Token { get; set; }
        public string PAI_0003300_Payment_Method_Token { get; set; }  // Renamed for distinctness (was a duplicate in the provided payload)
        public string PAI_0003400_Payment_Method_Token { get; set; }  // Renamed for distinctness (was a duplicate in the provided payload)
        public string PAI_0003500_Payment_Method_Token { get; set; }  // Renamed for distinctness (was a duplicate in the provided payload)
        public string PAI_0003600_Payment_Method_Token { get; set; }  // Renamed for distinctness (was a duplicate in the provided payload)
        public string PAI_0003700_Last_Stake_Date_and_Time { get; set; }  // You might want to use DateTime
